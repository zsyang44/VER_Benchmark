    ...
    arguments = {
        ...
        'path': [
            dict(name='--resnet101_pretrained',
                 default='D:\courses\Emotion_detection\Trial\Dataset\\resnet-101-kinetics.pth',
                 type=str,
                 help='Global path of pretrained 3d resnet101 model (.pth)'),
            dict(name='--root_path',
                 default="D:\courses\Emotion_detection\Trial",
                 type=str,
                 help='Global path of root directory'),
            dict(name="--video_path",
                 default="Dataset\VideoEmotion8--img",
                 type=str,
            ...
            dict(name='--audio_path',
                 type=str,
                 default='Dataset\VideoEmotion8--mp3',
